...
Route2_MapEvents:
	...
	warp_event  3, 11, ROUTE_2_FOREST_NORTH_GATE, 2
	warp_event  3, 43, ROUTE_2_FOREST_SOUTH_GATE, 3
	...
	bg_event 16, 16, BGEVENT_ITEM, Route2HiddenMaxEther
	bg_event  7, 13, BGEVENT_ITEM, Route2HiddenFullHeal
	bg_event  4, 27, BGEVENT_ITEM, Route2HiddenFullRestore
	bg_event 18, 45, BGEVENT_ITEM, Route2HiddenRevive

	def_object_events
	object_event 14, 57, SPRITE_BUG_CATCHER, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_TRAINER, 5, TrainerBugCatcherRob, -1
	...
	object_event 13, 45, SPRITE_BUG_CATCHER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_TRAINER, 3, TrainerBugCatcherDoug, -1
