	...
	tilecoll HEADBUTT_TREE, TALL_GRASS, HEADBUTT_TREE, TALL_GRASS ; 29
	...
	tilecoll HEADBUTT_TREE, HEADBUTT_TREE, FLOOR, HEADBUTT_TREE ; 31
	tilecoll WALL, TALL_GRASS, TALL_GRASS, TALL_GRASS ; 32
